...
#define SPI0            ((spi0Regs_t *)0xE0020000)
...
#define SPI1            ((spi1Regs_t *)0xE0068000)
...
#define SSPIMSC        SPI1->imsc      /* Interrupt Mask Set/Clear Register */
#define SSPRIS         SPI1->ris       /* Raw Interrupt Status Register */
#define SSPMIS         SPI1->mis       /* Masked Interrupt Register */
